...
urlpatterns = [
    path('token/refresh/', views.CustomRefreshView.as_view(), name='token_refresh'),  #Обновление токена
    ...
    path('posts/<int:post_id>/like/add/', views.LikeCreateView.as_view()),

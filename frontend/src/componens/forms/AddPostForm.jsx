...
const AddPostForm = ({ isOpen, onClose, onPostCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg =
        ...
        "Не удалось опубликовать пост. Попробуйте снова.";
  ...
  const filters = [
    ...
    { name: "Ч/Б", value: "grayscale", preview: "grayscale(1)" },
    {
      name: "Винтаж",
      value: "vintage",
      preview: "contrast(1.2) brightness(0.8) sepia(0.3)",
    },
    {
      name: "Ясность",
      value: "clarity",
      preview: "contrast(1.1) saturate(1.2)",
    },
  ];
